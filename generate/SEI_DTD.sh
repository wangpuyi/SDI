#!/bin/bash
#SBATCH --job-name=DTD-generate        # 作业名称
#SBATCH --output=/grp01/cs_hszhao/cs002u03/log_notImportant/DTD_%j_output.log  # 输出日志文件，使用数组作业ID和任务ID命名
#SBATCH --error=/grp01/cs_hszhao/cs002u03/log_notImportant/DTD_%j_error.log    # 错误日志文件
#SBATCH --ntasks=1                     
