...
#     --guidance_scale=2.0 \
#     --pt_root="/grp01/cs_hszhao/cs002u03/output/ProjTensor/PETs" \
#     --save_root="/grp01/cs_hszhao/cs002u03/output/SEI/PETs-Gaussian-10x-2.0" \
#     --data_root="/grp01/cs_hszhao/cs002u03/dataset/PETs/trainval" \
...
#     --guidance_scale=2.0 \
#     --pt_root="/grp01/cs_hszhao/cs002u03/output/ProjTensor/PETs" \
#     --save_root="/grp01/cs_hszhao/cs002u03/output/SEI/PETs-GMM3-10x-2.0" \
#     --data_root="/grp01/cs_hszhao/cs002u03/dataset/PETs/trainval" \
#     --expanded_number_per_sample=10 \
#     --sample_func="GMM3"
# python SEI_Generate.py \
#     --guidance_scale=2.0 \
#     --pt_root="/grp01/cs_hszhao/cs002u03/output/ProjTensor/PETs" \
#     --save_root="/grp01/cs_hszhao/cs002u03/output/SEI/PETs-GMM5-10x-2.0" \
#     --data_root="/grp01/cs_hszhao/cs002u03/dataset/PETs/trainval" \
#     --expanded_number_per_sample=10 \
#     --sample_func="GMM5"
python SEI_Generate.py \
    --guidance_scale=2.0 \
    --pt_root="/grp01/cs_hszhao/cs002u03/output/ProjTensor/PETs" \
    --save_root="/grp01/cs_hszhao/cs002u03/output/SEI/PETs-GMM2-10x-2.0" \
    --data_root="/grp01/cs_hszhao/cs002u03/dataset/PETs/trainval" \
    --expanded_number_per_sample=10 \
    --sample_func="GMM2"