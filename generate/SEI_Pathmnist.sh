#!/bin/bash
#SBATCH --job-name=pathmnist_224-generate        # 作业名称
#SBATCH --output=/grp01/cs_hszhao/cs002u03/log_notImportant/pathmnist_224%j_output.log  # 输出日志文件，使用数组作业ID和任务ID命名
#SBATCH --error=/grp01/cs_hszhao/cs002u03/log_notImportant/pathmnist_224%j_error.log    # 错误日志文件
#SBATCH --ntasks=1                     
