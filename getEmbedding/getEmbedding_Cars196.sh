...
python getEmbedding.py --total_split 1 --split $SLURM_ARRAY_TASK_ID \
 --projector_ckpt="/grp01/cs_hszhao/cs002u03/ckpt/adapter/Cars196/bs64-lr_0.0005-20240926-223735/checkpoint-99.pt" \
 --data_root="/grp01/cs_hszhao/cs002u03/dataset/StanfordCars/cars/train" \
 --save_root="/grp01/cs_hszhao/cs002u03/output/ProjTensor/Cars196" \