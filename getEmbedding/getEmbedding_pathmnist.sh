...
python getEmbedding.py --total_split 1 --split $SLURM_ARRAY_TASK_ID \
 --projector_ckpt="/grp01/cs_hszhao/cs002u03/ckpt/adapter/pathmnist_224/bs64-lr_0.0005-20241007-194559/checkpoint-99.pt" \
 --data_root="/grp01/cs_hszhao/cs002u03/dataset/MedMnist/pathmnist_224/val" \
 --save_root="/grp01/cs_hszhao/cs002u03/output/ProjTensor/pathmnist_224" \