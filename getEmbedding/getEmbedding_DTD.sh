...
python getEmbedding.py --total_split 1 --split $SLURM_ARRAY_TASK_ID \
 --projector_ckpt="/grp01/cs_hszhao/cs002u03/ckpt/adapter/DTD/bs64-lr_0.0005-20240930-220423/checkpoint-99.pt" \
 --data_root="/grp01/cs_hszhao/cs002u03/dataset/dtd/dtd_split/train" \
 --save_root="/grp01/cs_hszhao/cs002u03/output/ProjTensor/DTD" \