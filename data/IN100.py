...
IN100_labels = ['stingray', 'hen', 'magpie', 'kite', 'vulture',
...
# for (wnid, word) in sorted(zip(wnids, IN100_labels)):
#     print(f"pair: {wnid} {word}")
#     if "goldfish" == word:
#         print("no space")
words = [item[1] for item in sorted(zip(wnids, IN100_labels))]
wnids = sorted(wnids)
print(wnids)