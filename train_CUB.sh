...
#SBATCH --output=/grp01/cs_hszhao/cs002u03/log_notImportant/trainProjector/CUB_%j_output.log  # 输出日志文件，使用数组作业ID和任务ID命名
#SBATCH --error=/grp01/cs_hszhao/cs002u03/log_notImportant/trainProjector/CUB_%j_error.log
...
python train_Projector.py \
    ...
    --data_path="/grp01/cs_hszhao/cs002u03/dataset/CUB_200_2011/train" \
    ...
    --weight_decay=0.01 \
    --port=14368 \
    --output_dir="/grp01/cs_hszhao/cs002u03/ckpt/adapter/CUB"